...
public class EditorLocales extends t.me.p1azmer.engine.api.editor.EditorLocales {
    ...
    public static final EditorLocale REGION_BLOCK_RECIPE_CLEAR = builder(PREFIX + "Region.Block.Recipe.Clear")
      ...
      .build();
    // flags
    public static final EditorLocale REGION_FLAG_ADD = builder(PREFIX + "Region.Block.Flag.Add")
      .name("Added Flag")
      .emptyLine()
      ...
      .click(DRAG_DROP, "Add")
      .build();
    public static final EditorLocale REGION_FLAGS_CLEAR = builder(PREFIX + "Region.Block.Flags.Clear")
      .name("Clear breakers")
      .click(LMB, "Clear")
      .build();
    public static final EditorLocale REGION_FLAG_OBJECT = builder(PREFIX + "Region.Block.Flag.Object")
      .name(Placeholders.FLAG_NAME)
      .current("Values:", Placeholders.FLAG_VALUES)
      .emptyLine()
      .click(DRAG_DROP, "Add value")
