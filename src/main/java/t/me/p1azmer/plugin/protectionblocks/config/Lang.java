...
public class Lang extends EngineLang {
    ...
    public static final LangKey COMMAND_GIVE_DESC  = LangKey.of("Command.Give.Desc", "Give specified currency to a player.");
    ...
    public static final LangKey REGION_SUCCESS_DAMAGED_SELF = LangKey.of("Messages.Region.Success.Damaged.Self",
            RED+BOLD+"!! ALARM !!\n"+
    ...
    public static final LangKey REGION_DESTROY_NOTIFY = LangKey.of("Messages.Region.Notify.Destroy",
            RED+BOLD+"!! ALARM !!\n"+
