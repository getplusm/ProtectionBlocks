...
public class Config {
    ...
    public static final JOption<Boolean> ENABLE_PARTICLE_WHEN_CREATE = JOption.create(
      "Settings.Region.Create.Particle.Enabled",
      true,
      "Sets the display of particles when creating regions");
