...
public class RegionBlock extends AbstractConfigHolder<ProtectionPlugin> implements Placeholder {
  ...
  public RegionBlock(@NotNull RegionManager manager, @NotNull JYML cfg) {
    ...
    this.setRecipe(new BlockRecipe(this, Map.of(
      1, new ItemStack(Material.AIR),
      2, new ItemStack(Material.AIR),
      3, new ItemStack(Material.AIR),
      4, new ItemStack(Material.AIR),
      5, new ItemStack(Material.AIR),
      6, new ItemStack(Material.AIR),
      7, new ItemStack(Material.AIR),
      8, new ItemStack(Material.AIR),
      9, new ItemStack(Material.AIR))
      , false));
    ...
    this.placeholderMap = new PlaceholderMap()
      ...
      .add(Placeholders.REGION_BLOCK_RECIPE_ENABLED, () -> LangManager.getBoolean(this.getRecipe().isEnabled()))
  ...
  public boolean load() {
    ...
    if (!cfg.isSet("Region.Recipe")) {
      ...
      this.setRecipe(BlockRecipe.read(cfg, "Region", this));
    }
    return true;
  }
  ...
  @Nullable
  public RankMap<Integer> getLifeTime() {
    return lifeTime;
  }

  @Nullable
  public RankMap<Integer> getPlaceLimit() {
    return placeLimit;
  }

  @Nullable
  public RankMap<Integer> getGroupSize() {
    return groupSize;
  }
  ...
  public void setRecipe(@NotNull BlockRecipe blockRecipe) {
